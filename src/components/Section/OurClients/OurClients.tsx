            ...
            <div className="w-[100%] lg:w-[95%] max-h-auto flex-col items-start mt-10 lg:mt-20 mb-12 ">
                <div className="flex flex-col ml-20">
                    ...
                    <p className="text-gray-600 text-[16px] lg:text-[18px] font-secondary max-w-full lg:max-w-3xl mt-4 lg:mt-8">
                        Our clients are central to our mission. We believe that your success drives ours, which is why we are
                        committed to delivering exceptional service and high-quality software solutions tailored to your
                        needs.
                    </p>
                    ...
                    <div className="flex flex-wrap p-4 gap-6 lg:gap-12 justify-center lg:justify-start mt-6">
                        {[
                            ...
                            >
                                <Image src={client.src} alt={client.alt} width={100} height={50} />
                            </motion.div>
                        ))}
                    </div>
                </div>
