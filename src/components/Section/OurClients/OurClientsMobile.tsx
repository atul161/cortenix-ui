        ...
        <div className="w-[100vw] bg-white flex flex-col items-center p-12 overflow-hidden mt-16">
            ...
            <div className="w-full max-w-4xl flex flex-col items-center mt-6 mb-8">
                <div className="flex items-center gap-3 font-primary">
                    ...
                    />
                    <h2 className="text-[32px] md:text-3xl font-bold text-[#435CFF] font-primary"
                        style={{
                            background: "linear-gradient(90deg, #435CFF 0%, #834EFF 100%)",
                            WebkitBackgroundClip: "text",
                            WebkitTextFillColor: "transparent",
                ...
                <p className="text-gray-600 text-sm md:text-base font-secondary text-center max-w-2xl mt-4 leading-relaxed">
                    Our clients are central to our mission. We believe that your success drives ours, which is why we
                    are committed to delivering exceptional service and high-quality software solutions tailored to your
                    needs.
                </p>
            </div>
