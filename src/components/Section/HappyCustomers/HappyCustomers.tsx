...
const HappyCustomer: React.FC = () => {
  return (
    <div className="w-[100vw] h-[110vh] sm:w-[100vw] sm:h-[110vh] bg-gray-200 flex  justify-start items-start sm:flex sm:items-center sm:justify-center">
      {/* Centered container */}
      <div className="h-screen sm:h-[80%] w-[95%] md:w-[90%] flex flex-col md:flex-row items-center justify-center">
        ...
        <div className="h-full w-full md:w-[50%] lg:w-[45%] flex flex-col items-start justify-start p-8 mt-10  sm:p-4 md:p-6">
          ...
          <div className="relative flex flex-row mt-6 sm:mt-8 md:mt-10 lg:mt-12 w-[300px] sm:w-[350px] md:w-[400px]">
            ...
            <div className="absolute top-0 left-[65px] sm:left-[85px] w-[80px] h-[80px] sm:w-[100px] sm:h-[100px] border-[4px] sm:border-[6px] border-white rounded-full overflow-hidden">
              <Image
                src="/Images/HappyCustomer/HappyCustomer.jpeg"
                alt="HappyWomenImage"
                width={100}
            ...
            <div className="absolute top-0 left-[130px] sm:left-[170px] w-[80px] h-[80px] sm:w-[100px] sm:h-[100px] border-[4px] sm:border-[6px] border-white rounded-full overflow-hidden">
              <Image
                src="/Images/HappyCustomer/HappyCustomer.jpeg"
                alt="HappyWomenImage"
                width={100}
            ...
            <div className="absolute top-0 right-[40px] sm:right-[50px] w-[80px] h-[80px] sm:w-[100px] sm:h-[100px] border-[4px] sm:border-[6px] border-white rounded-full overflow-hidden">
              <Image
                src="/Images/HappyCustomer/HappyCustomer.jpeg"
                alt="HappyWomenImage"
                width={100}
